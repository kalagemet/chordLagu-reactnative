  ...
  render() {
    ...
    return (
      <View style={style.meter}>
        ...
        <View style={[style.scale, style.scale_1, {borderTopColor: "green"}]} />
        <View style={[style.scale, style.strong, {borderTopColor: "green"}]} />
        <View style={[style.scale, style.scale1, {borderTopColor: "green"}]} />
